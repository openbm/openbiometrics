...
- **[Active Liveness](/openbiometrics/api/active-liveness/)** — challenge-response anti-spoofing with presets
- **[Document Processing](/openbiometrics/api/documents/)** — MRZ parsing and document scanning
- **[Video Analytics](/openbiometrics/api/video-analytics/)** — real-time camera processing
- **[Events & Webhooks](/openbiometrics/api/events/)** — subscribe to biometric events
- **[Docker deployment](/openbiometrics/self-hosting/docker/)** — containerized setup
